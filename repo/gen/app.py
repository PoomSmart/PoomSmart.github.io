app = [
    {
        ...
        "changes": [
            ["2.3.26", "Updated JS and CSS for the recent GitHub changes"]
        ]
    },
    {
        ...
        "changes": [
            ["1.3.11", "Updated CSS for the recent ChatGPT changes"],
    ...
    },
    {
        ...
        "changes": [
            ["2.17.2", "Fixed device crashing (regression of 2.17.1)"],
            ["2.17.1", "Fixed TestFlight apps being broken (< 16.4, contributed by iCraze)"],
            ["2.17.0", [
