...
youtube = [
    ...
    },
    {
        ...
        "changes": [
            ["2.3.5", "Corrected frosted glass border radius"],
    ...
    },
    {
        ...
        "changes": [
            ["1.6.5", "Made \"Playback speed slider\" setting works when \"More speeds\" setting is not enabled (contributed by @Tonwalter888)"],
    ...
    },
    {
        ...
        "changes": [
            ["1.3.3", "Fixed setting scrubber color not working on old YouTube versions (regression of 1.3.2)"],
            ["1.3.2", "Fixed app crash on recent YouTube versions"],
            ["1.3.1", [
